...
public class UbahUsername extends javax.swing.JFrame {
    ...
    private boolean updateUsername(String newUsername, String password) {
        try {
            ...
            // Dapatkan entity user yang akan diupdate
            LoginEntity user = em.find(LoginEntity.class, oldUsername);
            if (user == null) {
            ...
            // Hapus entity lama dan buat entity baru dengan username baru
            em.remove(user);

            LoginEntity newUser = new LoginEntity(newUsername, user.getPasswordnya());
            em.persist(newUser);
